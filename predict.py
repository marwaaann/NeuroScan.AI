...
def run_prediction():
    ...
    test_image_path = r'C:\Users\USER\Desktop\Brain Tumor\brain_tumor_project\brain_tumor_dataset\Val\images\my_test_image.jpg'
    # ------------------
    ...
    results = model.predict(
        ...
        conf=0.5    # Only show detections with 50% or higher confidence
    )
    print("Prediction complete.")

    # --- Step 5: Process results ---
    if not results:
        print("--- SCRIPT WARNING ---")
    ...
    if len(results) > 0:
        ...
        if len(result.boxes) == 0:
            ...
            print("Detection summary: Tumors found!")
